...
final public class ARSLineProgressConfiguration: NSObject {
	...
	public static var circleColorOuter: CGColor = UIColor.ars_colorWithRGB(3.0, green: 169.0, blue: 244.0, alpha: 1.0).cgColor
	public static var circleColorMiddle: CGColor = UIColor.ars_colorWithRGB(255.0, green: 193.0, blue: 7.0, alpha: 1.0).cgColor
	public static var circleColorInner: CGColor = UIColor.ars_colorWithRGB(3.0, green: 169.0, blue: 244.0, alpha: 1.0).cgColor
